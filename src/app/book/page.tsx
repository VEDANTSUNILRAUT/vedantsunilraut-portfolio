...
export default function BookPage() {
  return (
    <section className="w-full max-w-6xl mx-auto px-6 pt-36 sm:pt-44 pb-28 flex-1 flex flex-col items-center justify-center text-center">
      ...
      >
        <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-fuchsia-400 mb-6">
          <Calendar className="w-7 h-7" />
        </div>

        <span className="text-xs uppercase tracking-widest text-fuchsia-400 font-mono font-semibold mb-3 block">
        ...
        <h1 className="font-eb-garamond text-4xl sm:text-6xl text-white font-normal mb-4 tracking-tight">
          Book a <span className="italic-gradient-text font-semibold">Call</span>
        </h1>

        <p className="font-source-code-pro text-sm sm:text-base text-neutral-300 max-w-lg leading-relaxed mb-8">
          Schedule a 1-on-1 strategy call to discuss Android app development, full-stack architecture, or project collaboration.
        </p>
